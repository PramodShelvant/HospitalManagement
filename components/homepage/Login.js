...
export default ()=>
<React.Fragment>
<div className="modal fade"  style={{zIndex:11}} id="login" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div className="modal-content bg-pink">
      ...
      <div className="modal-body">
        ...
        <form class="text-center p-3"> 
          <div class="h3 mb-4 text-white">Login</div>
  ...
  <button type="submit" class="btn btn-outline-danger w-25 text-white">Login</button>
</form>
<div class="text-center p-0">
  <button type="button" class="btn btn-link text-white text-center ">Forgot Password?</button>
